...
<body>
	...
	<section id="content">
		...
		<main>
			<div class="container">
        <h2 style="text-align: center; color: #3498db;">Club Officers Information</h2>
            ...
            <tbody id="tbody">
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        $clubLogoDisplay = ($row["ClubName"] !== $prevClubName) ? '<img src="' . $row["ClubLogo"] . '" alt="Club Logo" width="50">' : '';
